            ...
            Program(programPath) {
                ...
                programPath.traverse({
                    JSXElement: function (path) {
                        ...
                        const isImage = openingElement.name.name === "img";
                        const closingElement = path.node.closingElement;
                        if (openingElement) {
                            openingElement.name = t.jsxMemberExpression(t.jsxIdentifier("ReactFigma"), t.jsxIdentifier(isImage ? "Image" : "View"));
                        }
                        if (closingElement) {
                            closingElement.name = t.jsxMemberExpression(t.jsxIdentifier("ReactFigma"), t.jsxIdentifier(isImage ? "Image" : "View"));
                        }
                    ...
                    JSXAttribute: function (path) {
                        if (path.node.name.name === "className") {
                            ...
                            path.replaceWith(t.jsxAttribute(
                                ...
                                t.jsxExpressionContainer(t.arrayExpression([...previousStyle, t.callExpression(t.identifier("tailwind"), [path.node.value])]))
                            ));
                            if (styleNode) {
                                styleNode.remove();
                            }
